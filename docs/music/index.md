...
| 序号  |                     音高                      |             |        音名及其首调唱名        |
| :---: | :-------------------------------------------: | :---------: | :----------------------------: |
|  01   |   $(\frac{3}{2})^6f$ --> $\frac{729}{512}f$   | $1.423828f$ |         G♯（Si /siː/）         |
|  02   |   $(\frac{3}{2})^5f$ --> $\frac{243}{128}f$   | $1.898438f$ | D♭（Ra /ɹɑː/）、C♯（Di /diː/） |
|  03   |    $(\frac{3}{2})^4f$ --> $\frac{81}{64}f$    | $1.265625f$ | G♭（Se /seɪ/）、F♯（Fi /fiː/） |
...
|  09   |   $(\frac{3}{2})^{-2}f$ --> $\frac{16}{9}f$   | $1.777778f$ |         C（Do /doʊ/）          |
|  10   |  $(\frac{3}{2})^{-3}f$ --> $\frac{32}{27}f$   | $1.185185f$ |         F（Fa /fɑː/）          |
|  11   |  $(\frac{3}{2})^{-4}f$ --> $\frac{128}{81}f$  | $1.580247f$ | B♭（Te /teɪ/）、A♯（Li /liː/） |
|  12   | $(\frac{3}{2})^{-5}f$ --> $\frac{256}{243}f$  | $1.053498f$ | E♭（Me /meɪ/）、D♯（Ri /ɹiː/） |
|  13   | $(\frac{3}{2})^{-6}f$ --> $\frac{1024}{729}f$ | $1.404664f$ |         A♭（Le /leɪ/）         |
...
|        音名及其首调唱名        |       音高       |             |
| :----------------------------: | :--------------: | :---------: |
|         B（Ti /tiː/）          | $\frac{15}{8}f$  | $1.875000f$ |
...
<script>
  window.addEventListener('load', function () {
    Plotly.newPlot('tuningSummaryPlot', [
      ...
      {
        x: [1, 2, 3, 4, 5, 6, 7, 7, 8, 9, 10, 11, 12, 13],
...
| :------: | :-------------: | :-------------: | :-------------: | :-------------: | :--------------: | :--------------: | :---------------: | :---------------: |
|  **B**   |   B<--0<br>纯   |  C'<--1<br>小   |  D'<--3<br>小   |  E'<--5<br>纯   | F'=B+6<br>减五度 |   G'<--8<br>小   |   A'<--10<br>小   |   B'<--12<br>纯   |
| B♭<br>A♯ |                 |                 |                 |                 |                  |                  |                   |                   |
|  **A**   |   A<--0<br>纯   |   B<--2<br>大   |  C'<--3<br>小   |  D'<--5<br>纯   |   E'<--7<br>纯   |   F'<--8<br>小   |   G'<--10<br>小   |   A'<--12<br>纯   |
| A♭<br>G♯ |                 |                 |                 |                 |                  |                  |                   |                   |
|  **G**   |   G<--0<br>纯   |   A<--2<br>大   |   B<--4<br>大   |  C'<--5<br>纯   |   D'<--7<br>纯   |   E'<--9<br>大   |   F'<--10<br>小   |   G'<--12<br>纯   |
| G♭<br>F♯ |                 |                 |                 |                 |                  |                  |                   |                   |
|  **F**   |   F<--0<br>纯   |   G<--2<br>大   |   A<--4<br>大   | B=F+6<br>增四度 |   C'<--7<br>纯   |   D'<--9<br>大   |   E'<--11<br>大   |   F'<--12<br>纯   |
|  **E**   |   E<--0<br>纯   | F=E+1<br>小二度 |   G<--3<br>小   |   A<--5<br>纯   |   B<--7<br>纯    | C'<--8<br>小六度 |   D'<--10<br>小   |   E'<--12<br>纯   |
| E♭<br>D♯ |                 |                 |                 |                 |                  |                  |                   |                   |
|  **D**   |   D<--0<br>纯   |   E<--2<br>大   | F=D+3<br>小三度 |   G<--5<br>纯   |   A<--7<br>纯    |   B<--9<br>大    | C'<--10<br>小七度 |   D'<--12<br>纯   |
| D♭<br>C♯ |                 |                 |                 |                 |                  |                  |                   |                   |
|  **C**   | C=C+0<br>纯一度 | D=C+2<br>大二度 | E=C+4<br>大三度 | F=C+5<br>纯四度 | G=C+7<br>纯五度  | A=C+9<br>大六度  | B=C+11<br>大七度  | C'=C+12<br>纯八度 |

| 半音  |     一度     |     二度     |     三度     |     四度     |     五度     |     六度     |     七度     |     八度     |
| :---: | :----------: | :----------: | :----------: | :----------: | :----------: | :----------: | :----------: | :----------: |
|  12   |              |              |              |              |              |              | A7<br>增七度 | P8<br>纯八度 |
|  11   |              |              |              |              |              |              | M7<br>大七度 | d8<br>减八度 |
|  10   |              |              |              |              |              | A6<br>增六度 | m7<br>小七度 |              |
|   9   |              |              |              |              |              | M6<br>大六度 | d7<br>减七度 |              |
|   8   |              |              |              |              | A5<br>增五度 | m6<br>小六度 |              |              |
|   7   |              |              |              |              | P5<br>纯五度 | d6<br>减六度 |              |              |
|   6   |              |              |              | A4<br>增四度 | d5<br>减五度 |              |              |              |
|   5   |              |              | A3<br>增三度 | P4<br>纯四度 |              |              |              |              |
|   4   |              |              | M3<br>大三度 | d4<br>减四度 |              |              |              |              |
|   3   |              | A2<br>增二度 | m3<br>小三度 |              |              |              |              |              |
|   2   |              | M2<br>大二度 | d3<br>减三度 |              |              |              |              |              |
|   1   | A1<br>增一度 | m2<br>小二度 |              |              |              |              |              |              |
|   0   | P1<br>纯一度 | d2<br>减二度 |              |              |              |              |              |              |

|                                     |                  一度                  |                  二度                  |                     三度                     |                     四度                     |                     五度                     |                六度                 |                 七度                 |                  八度                   |
| :---------------------------------: | :------------------------------------: | :------------------------------------: | :------------------------------------------: | :------------------------------------------: | :------------------------------------------: | :---------------------------------: | :----------------------------------: | :-------------------------------------: |
|   完全协和<br>Perfect Consonances   | 纯一度<br>P1<br>$2^{\frac{0}{12}}=1:1$ |                                        |                                              |                                              | 纯五度<br>P5<br>$2^{\frac{7}{12}}\approx3:2$ |                                     |                                      | 纯八度<br>P8<br>$2^{\frac{12}{12}}=2:1$ |
|                                     |                                        |                                        |                                              | 纯四度<br>P4<br>$2^{\frac{5}{12}}\approx4:3$ |                                              |                                     |                                      |                                         |
| 不完全协和<br>Imperfect Consonances |                                        | 大二度<br>$2^{\frac{2}{12}}\approx9:8$ | 大三度<br>M3<br>$2^{\frac{4}{12}}\approx5:4$ |     增四度<br>$2^{\frac{6}{12}}\approx$      |                                              | 大六度<br>$2^{\frac{9}{12}}\approx$ | 大七度<br>$2^{\frac{11}{12}}\approx$ |                                         |
|                                     |                                        |  小二度<br>$2^{\frac{1}{12}}\approx$   | 小三度<br>m3<br>$2^{\frac{3}{12}}\approx6:5$ |                                              |     减五度<br>$2^{\frac{6}{12}}\approx$      | 小六度<br>$2^{\frac{8}{12}}\approx$ | 小七度<br>$2^{\frac{10}{12}}\approx$ |                                         |
|        不协和<br>Dissonances        |
